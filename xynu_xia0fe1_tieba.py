...
class Plugin(object):
    plugin_methods = {
                        'register':{'priority':30000,'func':'zhuce','desc':'注册插件'},
                        'enable':{'priority':30000,'func':'qiyong','desc':'启用插件'},
                        'disable':{'priority':30000,'func':'jinyong','desc':'禁用插件'},
                        'unregister':{'priority':30000,'func':'xiezai','desc':'卸载插件'},
                        'group_message':{'priority':30000,'func':'qun','desc':'群消息处理'},
                        'private_message':{'priority':30000,'func':'siliao','desc':'私聊消息处理'},
    ...
    def group_message(self,time,self_id,sub_type,message_id,fromgroup,fromAccount,anonymous,message,msg,font,sender):
        if msg =='1':
            self.util.send_group_msg(self.auth,fromgroup,'test')

        return False

    # def siliao(self,time,self_id,sub_type,message_id,fromAccount,message,msg,font,sender):
    #     sleep(10)
    #     return False
    ...
    def job(self):
        ...
        burp0_cookies = {" ab_sr": "1.0.1_"}
        burp0_headers = {"Connection": "close", "Cache-Control": "max-age=0", "sec-ch-ua": "\"Not)A;Brand\";v=\"99\", \"Google Chrome\";v=\"127\", \"Chromium\";v=\"127\"", "sec-ch-ua-mobile": "?0", "sec-ch-ua-platform": "\"Windows\"", "Upgrade-Insecure-Requests": "1", "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Safari/537.36", "Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7", "Sec-Fetch-Site": "none", "Sec-Fetch-Mode": "navigate", "Sec-Fetch-User": "?1", "Sec-Fetch-Dest": "document", "Accept-Encoding": "gzip, deflate", "Accept-Language": "zh-CN,zh;q=0.9,en;q=0.8"}
        ...
        if create_time > last_time:
            ...
            self.util.send_group_msg(self.auth,group,f'有新帖子\n标题：{title}\n内容：{text}\n链接：{link}')
